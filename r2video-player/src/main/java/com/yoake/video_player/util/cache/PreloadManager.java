...
public class PreloadManager {
     ...
     */
    public static final int PRELOAD_LENGTH = 1024 * 512;

    private PreloadManager(Context context) {
        mHttpProxyCacheServer = ProxyVideoCacheManager.getProxy(context.getApplicationContext());
    }
    ...
    public void addPreloadTask(String rawUrl, int position) {
        ...
        L.i("PreloadManager addPreloadTask: " + position);
    ...
    public void pausePreload(int position, boolean isReverseScroll) {
        L.d("PreloadManager pausePreload：" + position + " isReverseScroll: " + isReverseScroll);
    ...
    public void resumePreload(int position, boolean isReverseScroll) {
        L.d("PreloadManager resumePreload：" + position + " isReverseScroll: " + isReverseScroll);
