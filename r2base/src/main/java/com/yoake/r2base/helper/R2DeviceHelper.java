...
import com.yoake.r2base.OnceReadValue;
    ...
    private static void checkReadInfo() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                R2Log.printErrStackTrace(TAG, e, "read file error");
            } finally {
                R2LangHelper.close(fileInputStream);
            }
        }
        ...
        try {
            ...
            R2Log.printErrStackTrace(TAG, e, "read SystemProperties error");
        }
    }
