...
import com.yoake.r2base.AbsActivityLifecycleCallbacks;


public class R2KeyboardHelper {
    /**
     * 显示软键盘的延迟时间
     */
    ...
    public static void setVisibilityEventListener(final Activity activity,
        ...
        final View activityRoot = R2ViewHelper.getActivityRoot(activity);
        ...
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener =
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    private final int visibleThreshold = Math.round(
                            R2DisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
        ...
        activity.getApplication()
                .registerActivityLifecycleCallbacks(new AbsActivityLifecycleCallbacks(activity) {
                    @Override
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        View activityRoot = R2ViewHelper.getActivityRoot(activity);
        int visibleThreshold =
                Math.round(R2DisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
