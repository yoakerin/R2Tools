...
public class R2PermissionLauncher {
    ...
    public interface PermissionFail {
         ...
         */
        void onDenied(List<String> rejectPermissionList);
    }
    ...
    public R2PermissionLauncher with(@NonNull FragmentActivity activity) {
        this.hostActivity = activity;
        return this;
    }

    public R2PermissionLauncher with(@NonNull Fragment fragment) {
     ...
     * @return
     */
    public R2PermissionLauncher granted(PermissionSuccess permissionSuccessCallBack) {
     ...
     * @return
     */
    public R2PermissionLauncher denied(PermissionFail permissionFailCallBack) {
    ...
    private void doRequest(String[] permissions, @Nullable String[] permissionsName, @Nullable String[] permissionsRationale) {
        ...
        if (needPermissionRationaleCount == permissions.length) {
            ...
            R2Log.d(TAG, "request shouldShowRequestPermissionRationale onDenied");
        ...
        if (hostActivity != null) {
            ...
            R2Log.d(TAG, "request from activity");

        } else if (hostFragment != null) {
            R2Log.d(TAG, "request from fragment");
