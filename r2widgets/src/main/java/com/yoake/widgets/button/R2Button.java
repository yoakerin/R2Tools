...
package com.yoake.widgets.button;
...
import com.yoake.widgets.alpha.R2AlphaButton;
import com.yoake.widgets.layout.LayoutHelper;
import com.yoake.widgets.layout.R2Layout;


public class R2Button extends R2AlphaButton implements R2Layout {
    private LayoutHelper mLayoutHelper;

    public R2Button(Context context) {
        super(context);
        init(context, null, 0);
    }

    public R2Button(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public R2Button(Context context, AttributeSet attrs, int defStyleAttr) {
