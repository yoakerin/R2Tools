/*
 * Tencent is pleased to support the open source community by making r2_Android available.
 *
...
public class R2ImageView extends AppCompatImageView {
    ...
    public R2ImageView(Context context) {
        this(context, null, R.attr.R2ImageViewStyle);
    }

    public R2ImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.R2ImageViewStyle);
    }

    public R2ImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(
                attrs, R.styleable.R2ImageView, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.R2ImageView_r2_border_width, 0);
        mBorderColor = array.getColor(R.styleable.R2ImageView_r2_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.R2ImageView_r2_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(
                R.styleable.R2ImageView_r2_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.R2ImageView_r2_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.R2ImageView_r2_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.R2ImageView_r2_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.R2ImageView_r2_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(
                    R.styleable.R2ImageView_r2_corner_radius, 0);
        }
        array.recycle();
    }
