...
import com.yoake.widgets.alpha.AlphaViewHelper;
import com.yoake.widgets.layout.R2Layout;
import com.yoake.widgets.layout.LayoutHelper;


/**
 * shown image in radius view, is different to {@link R2ImageView}
 * the oval is not supported
 */
public class R2ImageView2 extends AppCompatImageView implements R2Layout {
    ...
    public R2ImageView2(Context context) {
        super(context);
        init(context, null, 0);
    }

    public R2ImageView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public R2ImageView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(
                attrs, R.styleable.R2ImageView2, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.R2ImageView2_r2_border_width, 0);
        mBorderColor = array.getColor(R.styleable.R2ImageView2_r2_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.R2ImageView2_r2_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(
                R.styleable.R2ImageView2_r2_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.R2ImageView2_r2_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.R2ImageView2_r2_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.R2ImageView2_r2_is_circle, false);
        if (!mIsCircle) {
            setRadius(array.getDimensionPixelSize(
                    R.styleable.R2ImageView2_r2_corner_radius, 0));
        }
        array.recycle();
