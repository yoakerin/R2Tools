...
public class AlphaViewHelper {
    ...
    public AlphaViewHelper(@NonNull View target) {
        ...
        mPressedAlpha = ResHelper.getAttrFloatValue(target.getContext(), R.attr.r2_alpha_pressed);
        mDisabledAlpha = ResHelper.getAttrFloatValue(target.getContext(), R.attr.r2_alpha_disabled);
    }
