...
import com.yoake.widgets.alpha.R2AlphaLinearLayout;


public class R2LinearLayout extends R2AlphaLinearLayout implements R2Layout {
    private LayoutHelper mLayoutHelper;

    public R2LinearLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public R2LinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public R2LinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
