...
import com.yoake.widgets.alpha.R2AlphaFrameLayout;


public class R2FrameLayout extends R2AlphaFrameLayout implements R2Layout {
    private LayoutHelper mLayoutHelper;

    public R2FrameLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public R2FrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public R2FrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
