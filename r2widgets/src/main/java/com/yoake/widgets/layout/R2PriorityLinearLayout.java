...
public class R2PriorityLinearLayout extends R2LinearLayout {
    ...
    public R2PriorityLinearLayout(Context context) {
        super(context);
    }

    public R2PriorityLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            final TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.R2PriorityLinearLayout_Layout);
            priority = a.getInteger(R.styleable.R2PriorityLinearLayout_Layout_r2_layout_priority,
                    PRIORITY_MINI_CONTENT_PROTECTION);
            miniContentProtectionSize = a.getDimensionPixelSize(
                    R.styleable.R2PriorityLinearLayout_Layout_r2_layout_miniContentProtectionSize,
                    0);
            a.recycle();
        }
