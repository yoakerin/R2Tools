...
import com.yoake.widgets.alpha.R2AlphaConstraintLayout;

public class R2ConstraintLayout extends R2AlphaConstraintLayout implements R2Layout {
    private LayoutHelper mLayoutHelper;

    public R2ConstraintLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public R2ConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public R2ConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
