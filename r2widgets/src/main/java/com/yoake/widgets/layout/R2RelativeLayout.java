...
import com.yoake.widgets.alpha.R2AlphaRelativeLayout;


public class R2RelativeLayout extends R2AlphaRelativeLayout implements R2Layout {
    private LayoutHelper mLayoutHelper;

    public R2RelativeLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public R2RelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public R2RelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
