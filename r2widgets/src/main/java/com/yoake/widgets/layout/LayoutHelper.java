...
import com.yoake.widgets.helper.ResHelper;

import java.lang.ref.WeakReference;

public class LayoutHelper implements R2Layout {
    ...
    private int mRadius;
    private @R2Layout.HideRadiusSide int mHideRadiusSide = HIDE_RADIUS_SIDE_NONE;
    ...
    public void setUseThemeGeneralShadowElevation() {
        mShadowElevation = ResHelper.getAttrDimen(mContext, R.attr.r2_general_shadow_elevation);
    ...
    @Override
    public void setRadius(int radius, @R2Layout.HideRadiusSide int hideRadiusSide) {
    ...
    @Override
    public void setRadiusAndShadow(int radius, @R2Layout.HideRadiusSide int hideRadiusSide, int shadowElevation, float shadowAlpha) {
